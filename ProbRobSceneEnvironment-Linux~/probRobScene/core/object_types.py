...
class Object(Point3D):
    ...
    def to_dict(self):
        return {
            ...
            'requireVisible': self.requireVisible,
            'allowCollisions': self.allowCollisions,
            'visibleDistance': self.visibleDistance,
            'position_x': self.position.x,
            'position_y': self.position.z,
            'position_z': self.position.y,
            'rotation_x': -self.orientation.z,
            'rotation_y': -self.orientation.x,
